...
load_env_file("/var/secure/aigrader.env") #Locate  .env in a folder (for example var/secure or user home) that is not web accesible
...
CONFIG = {
    "DEBUG": False,
    "BASE_URL": "https://yourserver.com", # Base URL for relative paths
